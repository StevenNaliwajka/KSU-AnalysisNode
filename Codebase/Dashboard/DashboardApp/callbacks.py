...
def register_callbacks(app, loader):
    ...
    def update_graph(y1_col, y2_col, y3_col, agg_str, start_date, end_date):
        # Handle "__none__" string used in dropdowns
        if y1_col == "__none__":
            y1_col = None
        if y2_col == "__none__":
            y2_col = None
