...
for i, metric in enumerate(metrics):
    ...
    ax2 = ax1.twinx()
    ax2.plot(soil1_df['timestamp'], soil1_df['soil_moisture'], label='Soil Sensor 1: 1"', color='green')#, alpha=0.5, s=100)
    ax2.plot(soil2_df['timestamp'], soil2_df['soil_moisture'], label='Soil Sensor 2: 3"', color='orange')#, alpha=0.5, s=100)
    ...
    if i == 0:
        ax1.set_title("TVWS RSSI and Soil Moisture Over Time")
